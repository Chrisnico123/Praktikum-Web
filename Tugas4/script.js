function theme() {
  ...
  var index = document.getElementById("darknama");
  if (index.value == 2) {
    document.getElementById("nama").style.backgroundColor = `#191919`;
